...
int main(int argc, char **argv)
{
  ...
  move_group.setApproximateJointValueTarget(target_pose1, move_group.getEndEffectorLink().c_str());// the comment is command setting position using option allowing approximate IK solution
  //move_group.setPoseTarget(target_pose1);   // the comment is general command setting objective(goal, target) position
  //move_group.setPositionTarget(target_pose1.position.x , target_pose1.position.y, target_pose1.position.z , move_group.getEndEffectorLink().c_str());
  //bool flg = move_group.impl_->setJointValueTarget(target_pose1, move_group.getEndEffectorLink().c_str(),move_group.getPlanningFrame().c_str(), true);
...
bool success = move_group.move() == moveit::planning_interface::MoveItErrorCode::SUCCESS;
  ...
  ROS_INFO(" ----- END ---------- :Planning to a joint-space goal");
  visual_tools.prompt("next step - 1");
 ...
 success = move_group.move() == moveit::planning_interface::MoveItErrorCode::SUCCESS;
  ...
  visual_tools.publishTrajectoryLine(my_plan.trajectory_, joint_model_group);
  visual_tools.trigger();
  visual_tools.prompt("next step - 2");
 ...
 success = move_group.move() == moveit::planning_interface::MoveItErrorCode::SUCCESS;
  ...
  visual_tools.publishTrajectoryLine(my_plan.trajectory_, joint_model_group);
  visual_tools.trigger();
  visual_tools.prompt("next step - 3");
 ...
 success = move_group.move() == moveit::planning_interface::MoveItErrorCode::SUCCESS;
  ...
  visual_tools.publishTrajectoryLine(my_plan.trajectory_, joint_model_group);
  visual_tools.trigger();
  visual_tools.prompt("next step - 5");
